...
WriteHtmlOverviewToFile()
{
    ...
    local buildFile=""
    local osLogo=""
    local osVersion=$(GetOsName)

    case "${osVersion}" in
        "Leopard")       osLogo="overview_logo_leo" ;;
        "SnowLeopard")   osLogo="overview_logo_sl" ;;
        "Lion")          osLogo="overview_logo_lion" ;;
        "MountainLion")  osLogo="overview_logo_ml" ;;
        "Mavericks")     osLogo="overview_logo_mav" ;;
        "Yosemite")      osLogo="overview_logo_yos" ;;
        "ElCapitan")     osLogo="overview_logo_cap" ;;
        "Sierra")        osLogo="overview_logo_sierra" ;;
    esac
