...
// Copyright (C) 2013-2016 Blackosx
//
...
//
// Blackosx - Feb 2013 -> September 2016
//
//
        ...
        if (atCheck == 3 ) {
            ...
            switch(firstLineCommand) {
                ...
                case "UserLastOptions":                                     // Bash sends: "UserLastOptions@${prevOptions}@"
                    ...
                    break;
                case "csrBitsAndKexts":                                     // Bash sends: "csrBitsAndKexts@${gCSR_ALLOW_DEVICE_CONFIGURATION},${gCSR_ALLOW_UNRESTRICTED_NVRAM},
                                                                            //              ${gCSR_ALLOW_UNRESTRICTED_DTRACE},${gCSR_ALLOW_APPLE_INTERNAL},
                                                                            //              ${gCSR_ALLOW_KERNEL_DEBUGGER},${gCSR_ALLOW_TASK_FOR_PID},${gCSR_ALLOW_UNRESTRICTED_FS},
                                                                            //              ${gCSR_ALLOW_UNTRUSTED_KEXTS}:${gDrvLoadedD},${gDrvLoadedP},${gDrvLoadedR},${gDrvLoadedV}@"
                    MacGap.removeMessage(firstLine);
...
function formButtonPressed(f,whichButton)
{
    if(whichButton=="run") {
        ...
        if ($(codecid).prop('checked') || $(biosSystem).prop('checked') || $(biosVideo).prop('checked') || $(diskLoaderConfigs).prop('checked') || $(bootLoaderBootSectors).prop('checked') || $(diskPartitionInfo).prop('checked') || $(firmmemmap).prop('checked') || $(kexts).prop('checked') || $(lspci).prop('checked') || $(memory).prop('checked')) {
